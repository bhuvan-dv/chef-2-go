...
const VideoCard: React.FC<VideoCardProps> = ({ videoUrl }) => {
  ...
  return (
    ...
    <div className="bg-gray-100 overflow-hidden rounded-lg shadow-lg group transition-transform transform hover:scale-105">
      ...
      <div className="p-4">
        <p className="text-xl font-Morion font-semi-bold  text-gray-800 mb-2">Video Title</p>
        <p className="text-gray-600">{/* Additional video information */}</p>
        {/* <button className='bg-dark-green p-3 rounded-md text-white hover:bg-gradient-to-r hover:from-green-400 hover:to-blue-500 hover:text-white hover:font-semibold transition animate-ease-in'> Watch Now</button> */}
      </div>
    </div>
    </div>
  );
